...
;(function ($, window, document, undefined) {
    ...
    var defaults = {
        ...
        cartItemTemplate: '<img class="img-responsive pull-left" src="{product_image}" /><h6 style="font-size:12px; font-weight:300;" class="list-group-item-heading">{product_name}</h6><p class="list-group-item-text">{product_desc}</p>',
        ...
        lang: { // Language variables
            cartTitle: "Total Keranjang Belanja",
            checkout: 'Bayar',
            clear: 'Hapus',
            subtotal: 'Total:',
            cartRemove: 'x',
            cartEmpty: 'Keranjang belanja masih kosong!<br>Silakan pilih produk.'
        },
        submitSettings: {
    ...
    $.extend(SmartCart.prototype, {
        ...
        _setToolbar: function () {
            ...
            if (this.options.toolbarSettings.showCartSummary) {
                ...
                panelSubTotal.append(this.options.lang.subtotal).append(' <div class="sc-cart-subtotal">0</div>');
