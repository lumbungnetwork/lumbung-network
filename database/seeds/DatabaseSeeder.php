    ...
    public function run()
    {
        ...
        $users = array(
            array(
                ...
                'name' => 'Super Admin',
                'username' => 'superadmin@lumbungnetwork.com',
                'is_active' => 1,
                'user_type' => 1,
                'id_type' => 0,
            ),
            array(
                ...
                'name' => 'Master Admin',
                'username' => 'masteradmin@lumbungnetwork.com',
                'is_active' => 1,
                'user_type' => 2,
                'id_type' => 0,
            ),
            array(
                ...
                'name' => 'Admin 1',
                'username' => 'admin@lumbungnetwork.com',
                'is_active' => 1,
                'user_type' => 3,
                'id_type' => 0,
            ),
        ...
        $getUser001 = DB::table('users')->where('email', '=', 'top001@lumbungnetwork.com')->where('username', '=', 'top001')->first();
