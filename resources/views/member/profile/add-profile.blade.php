                    ...
                    <div class="row">
                        <div class="col-12">
                            <fieldset class="form-group">
                                <label for="input_nama_lengkap">Nama Lengkap (sesuai dengan Nama pada Rekening
                                    Bank)</label>
                        ...
                        <div class="col-12">
                            <button type="submit" class="btn btn-block btn-primary" id="submitBtn" data-toggle="modal"
...
<script>
    function inputSubmit(){
           ...
           var provinsi = $("#provinsi").val();
            $.ajax({
                type: "GET",
                url: "{{ URL::to('/') }}/m/cek/add-profile?full_name="+full_name+"&gender="+gender+"&kota="+kota+"&provinsi="+provinsi+"&kecamatan="+kecamatan+"&kelurahan="+kelurahan+"&alamat="+alamat,
