        ...
        <div class="mt-min-10">
            <div class="container">
                ...
                <div class="rounded-lg bg-white p-3 mb-3">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <button class="btn btn-success btn-lg mb-3" data-toggle="modal"
                                data-target="#addProductModal">+ Product</button>
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            @else
                            <div class="container">
                                <h4 class="text-center">Anda belum memiliki produk. Silakan buat produk dengan klik
                                    tombol + Product di atas.</h4>
                            </div>
                            @endif
                    ...
                    <form id="form-add" method="POST" action="/m/add/product">
                        ...
                        <div class="row">
                            <div class="col-6" id="product-image">
                                <img src="{{ asset('/asset_new/img/products') }}/default.jpg" style="max-width: 100px;"
                                    alt="">
                            </div>
                            <div class="col-6">
...
<script type="text/javascript">
    ...
    function selectName(val) {
        var newImage = `<img src="{{ asset('/asset_new/img/products') }}/` + val +`" style="max-width: 100px;" alt="">`;
        $("#get_name").val(val);
        $("#product-image").empty();
        $("#get_id-box").hide();
