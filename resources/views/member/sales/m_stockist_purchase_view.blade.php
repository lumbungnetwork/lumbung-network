        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-5 col-xs-12">
                    <div class="card">
                        <img class="card-img-top img-fluid" src="/image/icon.png" alt="{{$getData->name}}">
                        <div class="card-block">
                            <h4 class="card-title">{{$getData->name}}</h4>
                            <h5 class="card-text">Harga Rp. {{number_format($getData->stockist_price, 0, ',', '.')}}</h5>
                            <p class="card-text"><?php echo $getData->name; ?>{{$getData->ukuran}}</p>
                        </div>
                    </div>
                </div>
...
<script>
       function inputSubmit(){
           var total_buy = $("#total_buy").val();
            $.ajax({
                type: "GET",
                url: "{{ URL::to('/') }}/m/stockist/cek/shoping?id_barang="+{{$getData->id}}+"&total_buy="+total_buy ,
