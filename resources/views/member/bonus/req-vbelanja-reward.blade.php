                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-6 col-lg-6 col-xl-6">
                            <div class="card-box tilebox-one">
                                ...
                                <h2 class="m-b-20">{{round($getTotal, 2)}} LMB</h2>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                                        $kelipatan = $row->month_sale_price / 1000 * 0.02;
                                                        $reward = '--';
                                                        if($kelipatan > 0){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($row->canClaim == 1)
                                            <a rel="tooltip" data-toggle="modal" data-target="#confirmSubmit"
                                                class="btn btn-success btn-sm"
                                                href="{{ URL::to('/') }}/m/cek/confirm-vbelanja-reward?m={{$row->month}}&y={{$row->year}}">
                                                Claim
                                            </a>
                                            @endif
                                            @if($row->canClaim == 0)
