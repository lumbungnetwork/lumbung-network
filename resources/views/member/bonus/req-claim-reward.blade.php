                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="rounded bg-white p-3 text-center">
                                @if($dataMy->image != null)
                                <img src="/image/koin_lmb.png" class="img-responsive pull-xs-right text-muted"
                                    alt="user" style="height: 90px;">
                                @endif
                                <div class="">
                                    <h6 class="text-muted text-uppercase m-b-15 m-t-10">Claim Reward</h6>
