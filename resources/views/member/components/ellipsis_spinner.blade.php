{{-- EllipsisSpinner --}}
<svg xmlns="http://www.w3.org/2000/svg" width="100" height="20" preserveAspectRatio="xMidYMid"
    style="background: none;">
    <rect id="backgroundrect" width="100%" height="100%" x="0" y="0" fill="none" stroke="none" />
    <!--circle(cx="16",cy="50",r="10")-->
    <g class="currentLayer" style="">
        <title>Layer 1</title>
        <circle cx="84" cy="10" r="0" fill="#dce4eb" id="svg_1" class="">
        ...
        <circle cx="33.9276" cy="10" r="10" fill="#bbcedd" id="svg_2" class="">
        ...
        <circle cx="16" cy="10" r="5.27281" fill="#85a2b6" id="svg_3" class="">
            <animate attributeName="r" values="0;10;10;10;0" keyTimes="0;0.25;0.5;0.75;1"
                keySplines="0 0.5 0.5 1;0 0.5 0.5 1;0 0.5 0.5 1;0 0.5 0.5 1" calcMode="spline" dur="2.5s"
        ...
        <circle cx="84" cy="10" r="4.72719" fill="#fdfdfd" id="svg_4" class="">
            <animate attributeName="r" values="0;10;10;10;0" keyTimes="0;0.25;0.5;0.75;1"
                keySplines="0 0.5 0.5 1;0 0.5 0.5 1;0 0.5 0.5 1;0 0.5 0.5 1" calcMode="spline" dur="2.5s"
                repeatCount="indefinite" begin="0s" />
            <animate attributeName="cx" values="16;16;50;84;84" keyTimes="0;0.25;0.5;0.75;1"
        ...
        <circle cx="67.9276" cy="10" r="10" fill="#dce4eb" id="svg_5" class="">
