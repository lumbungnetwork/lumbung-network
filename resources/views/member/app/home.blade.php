...
<div class="bg-white px-4 py-2">
            ...
            <div class="flex justify-end">
                <div class="relative">
                    ...
                    <a href="{{ route('member.notifications') }}">
                        <div
                            class="absolute flex justify-center items-center top-0 -right-1 w-4 h-4 rounded-full bg-red-600">
                            <div class="text-xs text-white">{{$total_notifs}}</div>
                        </div>
                    </a>
                    @endif
    ...
    {{-- Search box --}}
    <div class="mt-3 mb-2">
        <div class="border border-gray-300 rounded-full py-1 px-2 w-full h-10">
            <form action="{{ route('member.shopping.postSearchProduct') }}" method="POST" autocomplete="off" id="search-product-form">
                @csrf
                <div class="flex space-x-1">
                    ...
                    placeholder="cari beras, gula, minyak..." name="keyword">
                </div>
            </form>
        </div>
    </div>
