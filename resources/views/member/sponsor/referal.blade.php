            ...
            <div class="card-box m-b-0">
                ...
                <div class="m-t-30 m-b-20">
                    ...
                    <form class="form-horizontal m-t-20" method="post" action="/refsp">
                        ...
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input type="text" class="form-control" placeholder="No. Handphone" name="hp" autocomplete="off" value="{{$dataValue->hp}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-12">
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                <input type="password" class="form-control" placeholder="Re-type Password" name="repassword" autocomplete="off">
                            </div>
                        </div>
