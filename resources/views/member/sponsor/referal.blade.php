                ...
                <div class="card-box widget-user">
                    <div>
                        ...
                        <div class="wid-u-info">
                            <h5 class="m-t-20 m-b-5">{{$dataUser->username}}</h5>
            ...
            <div class="m-t-30 m-b-20">
                ...
                <form class="form-horizontal m-t-20" method="post" action="/ref">
                    ...
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input type="email" class="form-control" placeholder="Email" name="email" autocomplete="off"
                                value="{{$dataValue->email}}" required="">
                        </div>
                    </div>
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input type="text" class="form-control allownumericwithoutdecimal"
                                placeholder="No. Handphone" name="hp" autocomplete="off" value="{{$dataValue->hp}}"
                                required="">
                        </div>
                    </div>
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input type="text" class="form-control" placeholder="Username" name="username"
                                autocomplete="off" value="{{ Session::get('username') }}" required="">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
                    ...
                    <div class="form-group text-center m-t-30">
                        <input type="hidden" name="ref" class="form-control" value="{{$dataUser->username}}">
                        <div class="col-xs-12">
