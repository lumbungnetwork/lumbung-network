            ...
            <div class="mt-min-10">
                <div class="container">
                    ...
                    <div class="rounded-lg bg-white p-3 mb-3">
                        ...
                        <div class="row">
                            <div class="col-3 mb-3">
                                <a href="{{ URL::to('/') }}/m/purchase/input-stock" class="text-decoration-none">
                                    <div class="rounded icon-ppob text-center">
                                        <div class="box-icon bg-green text-center">
                            ...
                            <div class="col-3 mb-3">
                                <a href="{{ URL::to('/') }}/m/purchase/list-stock" class="text-decoration-none">
                                    <div class="rounded icon-ppob text-center">
                                        <div class="box-icon bg-green text-center">
                                            <i class="mdi mdi-clipboard-flow-outline icon-menu"></i>
                                        </div>
                                        <dd>Lihat Transaksi</dd>
                                    </div>
                                </a>
                            </div>
                            <div class="col-3 mb-3">
                                <a href="{{ URL::to('/') }}/m/purchase/my-stock" class="text-decoration-none">
                                    <div class="rounded icon-ppob text-center">
                                        <div class="box-icon bg-green text-center">
                    ...
                    <div class="rounded-lg bg-white p-3 mb-3">
                        ...
                        <div class="row">
                            <div class="col-3 mb-3">
                                <a href="{{ URL::to('/') }}/m/purchase/input-vstock" class="text-decoration-none">
                                    <div class="rounded icon-ppob text-center">
                                        <div class="box-icon bg-green text-center">
                                            <i class="mdi mdi-view-grid-plus-outline icon-menu"></i>
                                        </div>
                            ...
                            <div class="col-3 mb-3">
                                <a href="{{ URL::to('/') }}/m/purchase/list-vstock" class="text-decoration-none">
                                    <div class="rounded icon-ppob text-center">
                                        <div class="box-icon bg-green text-center">
                                            <i class="mdi mdi-clipboard-flow-outline icon-menu"></i>
                                        </div>
                            ...
                            <div class="col-3 mb-3">
                                <a href="{{ URL::to('/') }}/m/purchase/my-vstock" class="text-decoration-none">
                                    <div class="rounded icon-ppob text-center">
                                        <div class="box-icon bg-green text-center">
                                            <i class="mdi mdi-view-grid-outline icon-menu"></i>
                                        </div>
