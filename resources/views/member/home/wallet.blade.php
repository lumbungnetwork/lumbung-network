                ...
                <div class="container">
                    ...
                    <div class="rounded-lg bg-white p-3 mb-3">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <a tabindex="0" class="btn btn-sm btn-outline-warning" role="button" data-toggle="popover" data-trigger="focus" title="Konversi Saldo Bonus ke eIDR" data-content="Mengajukan Penarikan Saldo Bonus ke Dompet Tron anda dalam bentuk eIDR. Minimum penarikan Rp10.000,- (Biaya Rp3.000,- per konversi.)">Apa ini?</a>

                            <div class="form-row mt-2">
                                <div class="form-group col-7">
                                    <input type="text" class="form-control form-control-sm allownumericwithoutdecimal" id="input_jml" name="jml_wd" aria-describedby="textHelp" autocomplete="off" placeholder="Jumlah Konversi">
                                </div>
                                <div class="form-group col-5">
                                    <button type="submit" class="btn btn-sm btn-success btn-block mb-2" id="submitBtn" data-toggle="modal" data-target="#confirmSubmit" onClick="inputSubmit()"> <span class="f-14"> Konversi </span></button>
                        ...
                        <div class="form-group mt-5">
                            ...
                            <a tabindex="0" class="btn btn-sm btn-outline-warning" role="button" data-toggle="popover" data-trigger="focus" title="Request Top-up eIDR" data-content="Mengajukan Pengisian Saldo (Top-up) eIDR melalui transfer Bank. Saldo eIDR akan masuk ke alamat TRON anda setelah bukti transfer anda dikonfirmasi oleh sistem.">Apa ini?</a>
                            <div class="form-row mt-2">
                                <div class="form-group col-7">
                                    <input type="text" class="form-control form-control-sm allownumericwithoutdecimal" id="input_jml_topup" aria-describedby="textHelp" name="input_topup" autocomplete="off" placeholder="Jumlah Konversi">
                                </div>
                                <div class="form-group col-5">
                                    <button type="submit" class="btn btn-sm btn-success btn-block mb-2" id="submitBtn" data-toggle="modal" data-target="#confirmSubmitTopUp" onClick="inputSubmitTopUp()"> <span class="f-14"> Top-up </span></button>
