            ...
            <div class="container">
                <div class="rounded-lg bg-white p-3 mb-3">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <p class="f-14">
                                Lumbung Network adalah platform desentralisasi yang mengutamakan transparasi, dijalankan
                                dengan prinsip
                                managemen terbuka.
                            </p>
                            <p class="f-14">
                            ...
                            <p class="f-14">
                                Anda bisa menelusuri pengguna (user) lain atau data statistik perkembangan Lumbung
                                Network disetai perhitungan-perhitungan
                                pembagian hasilnya
                            </p>
                        </div>
                    </div>
