                                ...
                                <table cellspacing="0" cellpadding="0" width="100%">
                                    <tr>
                                        <td class="hide-for-mobile" height="150" valign="top">
                                            ...
                                            <br>
                                            <span>Komunitas Konsumen, Pemasar dan Pedagang kebutuhan pokok</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="hide-for-mobile" style="height:180px; width:140px;">
                                            <img width="140"
                                                src="https://member.lumbung.network/image/logo_lumbung2.png"
                                                alt="Lumbung Network Logo" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                    ...
                                    <tr>
                                        <td class="body-cell body-cell-left-pad" width="355" height="661" valign="top">
                                            ...
                                            <table cellspacing="0" cellpadding="10" width="100%">
                                                <tr>
                                                    <td>
                                                        <b>Selamat Datang ke Lumbung Network!</b><br>
                                                        Kami sangat senang anda bergabung dengan keluarga besar Lumbung
                                                        Network!
                                                        <br>
                                                        Silakan login:
                                                    </td>
