...
<head>
    ...
    <title>Lumbung Network Registration</title>
                                ...
                                <table cellspacing="0" cellpadding="0" width="100%">
                                    <tr>
                                        <td class="hide-for-mobile" height="150" valign="top">
                                            <b>
                                                <span>Lumbung Finance</span>
                                            </b>
                                            <br>
                                            <span>Easy Access to Decentralized Finance Exposure</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="hide-for-mobile" style="height:180px; width:140px;">
                                            <img width="140"
                                                src="https://member.lumbung.network/image/lumbung-finance_1.png"
                                                alt="Lumbung Finance" />
                                        </td>
                                    </tr>
                                </table>
                                    ...
                                    <tr>
                                        <td class="body-cell body-cell-left-pad" width="355" height="661" valign="top">
                                            ...
                                            <table cellspacing="0" cellpadding="10" width="100%">
                                                <tr>
                                                    <td>
                                                        <b>Welcome to Lumbung Finance!</b><br>
                                                        We glad you join us for better future!
                                                        <br>
                                                        Please Login:
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="150" style="width:150px;">
                                                        <div style="text-align:center; background-color:#97951b;">
                                                            ...
                                                            <a href="https://finance.lumbung.network/login">
                                                                <table cellspacing="0" cellpadding="0" width="100%"
                                                                    style="width:100%">
                                                                    <tr>
                                                                        <td
                                                                            style="background-color:#48be19;border-radius:5px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:16px;line-height:45px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;mso-hide:all;">
                                                                            <span style="color:#ffffff">Login
                                                                                Now!</span></td>
                                                                    </tr>
                                                                </table>
                                                            </a>
