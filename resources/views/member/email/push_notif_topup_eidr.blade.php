                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="word-wrap:break-word;font-size:0px;padding:20px 30px 18px;" align="left">
                                                    <div style="cursor:auto;color:#000000;font-family:Open Sans, Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:20px;line-height:22px;text-align:left;">Berikut Data Request TopUp eIDR Member {{date('d F Y',strtotime("-1 days"))}}</div>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table role="presentation" cellpadding="0" cellspacing="0" style="background:white;" width="100%" border="0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="word-wrap:break-word;font-size:0px;padding:0px 30px 18px;" align="left">
                                                    <div style="cursor:auto;color:#000000;font-family:Open Sans, Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:14px;line-height:22px;text-align:left;">Tron</div>
                                                </th>
                                                <th style="word-wrap:break-word;font-size:0px;padding:0px 30px 18px;" align="left">
                                                ...
                                                <th style="word-wrap:break-word;font-size:0px;padding:0px 30px 18px;" align="left">
                                                    <div style="cursor:auto;color:#000000;font-family:Open Sans, Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:14px;line-height:22px;text-align:left;">Nama Rek</div>
                                                </th
                                                <th style="word-wrap:break-word;font-size:0px;padding:0px 30px 18px;" align="left">
                                                ...
                                                <th style="word-wrap:break-word;font-size:0px;padding:0px 30px 18px;" align="left">
                                                    <div style="cursor:auto;color:#000000;font-family:Open Sans, Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:14px;line-height:22px;text-align:left;">Jml</div>
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
