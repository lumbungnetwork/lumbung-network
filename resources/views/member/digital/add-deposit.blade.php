                    ...
                    <div class="row">
                        <div class="col-xl-12 col-xs-12">
                            <fieldset class="form-group">
                                <label for="input_jml_deposit">Nominal Isi Deposit</label>
                                <input type="text" inputmode="numeric" pattern="[0-9]*"
                                    class="form-control allownumericwithoutdecimal invalidpaste" id="input_jml_deposit"
                                    name="nominal_deposit" autocomplete="off">
                            </fieldset>
                        </div>
                    </div>
                    <div class="row">
...
<script>
    function inputSubmit(){
           var total_deposit = $("#input_jml_deposit").val();
            $.ajax({
                type: "GET",
                url: "{{ URL::to('/') }}/m/cek/add-deposit?total_deposit="+total_deposit,
