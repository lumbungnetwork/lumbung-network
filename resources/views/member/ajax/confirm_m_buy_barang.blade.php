<div class="modal-content">
    ...
    <div class="modal-body"  style="overflow-y: auto;max-height: 330px;">
        <form id="form-add" method="post" action="/m/shoping">
            {{ csrf_field() }}
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="stockist_id" value="{{$stokist_id}}">
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-9 col-xs-12">
                    <div class="form-group">
                        <label>Harga</label>
                        <input type="text" class="form-control" readonly="" value="Rp. {{number_format($getData->member_price * $qty, 0, ',', '.')}}">
                    </div>
                </div>
