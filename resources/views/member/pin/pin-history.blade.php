                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-6 col-lg-6 col-xl-6">
                            <div class="card-box tilebox-one">
                                ...
                                <h6 class="text-muted text-uppercase m-b-20">History Pin</h6>
                            </div>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="table-responsive">
                                ...
                                <div class="alert alert-{{ Session::get('messageclass') }} alert-dismissible"
                                    role="alert">
                                ...
                                <table id="datatable" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><label class="btn btn-{{$label}}">{{$status}}<br>{{$row->total_pin}}
                                                    PIN</td>
                                        </tr>
                                        @endforeach
                                        @endif
