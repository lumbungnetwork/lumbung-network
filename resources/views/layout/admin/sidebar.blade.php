                    ...
                    <ul class="nav">
                        ...
                        <li>
                            <a href="{{ URL::to('/') }}/adm/list/belanja-reward">
                                <span class="sidebar-mini-icon">+</span>
                                <span class="sidebar-normal"> Claim Reward Belanja Stockist </span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ URL::to('/') }}/adm/list/vbelanja-reward">
                                <span class="sidebar-mini-icon">+</span>
                                <span class="sidebar-normal"> Claim Reward Belanja Vendor</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ URL::to('/') }}/adm/list/penjualan-reward">
                                <span class="sidebar-mini-icon">+</span>
                                <span class="sidebar-normal"> Claim Reward Penjualan Stockist</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ URL::to('/') }}/adm/list/vpenjualan-reward">
                                <span class="sidebar-mini-icon">+</span>
                                <span class="sidebar-normal"> Claim Reward Penjualan Vendor</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ URL::to('/') }}/adm/list/claim-reward">
                                <span class="sidebar-mini-icon">+</span>
                                <span class="sidebar-normal"> Claim Reward Peringkat</span>
                            </a>
                        </li>
                        <li>
