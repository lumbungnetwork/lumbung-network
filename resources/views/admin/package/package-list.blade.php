                        ...
                        @endif
                         <div class="table-responsive">
                            <table class="table" id="myTable">
                                    ...
                                    @if($package != null)
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>{{$row->pin}}</td>
                                                <td>{{number_format($row->stock_wd, 0, ',', ',')}}</td>
                                                <td>{{$row->discount}}</td>
                             ...
                             <div class="modal fade" id="editPackage" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="false">
