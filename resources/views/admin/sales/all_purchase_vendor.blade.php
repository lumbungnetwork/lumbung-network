            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-info btn-fill btn-sm" href="{{ URL::to('/') }}/adm/add/vpurchase">Tambah Produk Vendor</a>
                    </div>
                    <div class="card-body">
                                    ...
                                    @if($getData != null)
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>{{$row->area}}</td>
                                                <td>
                                                    <a class="text-info" href="{{ URL::to('/') }}/adm/edit/vpurchase/{{$row->id}}">edit</a>
                                                    &nbsp;&nbsp;
                                                     <a rel="tooltip"  data-toggle="modal" data-target="#rmThis" class="text-danger" href="{{ URL::to('/') }}/ajax/rm/vpurchase/{{$row->id}}">hapus</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
