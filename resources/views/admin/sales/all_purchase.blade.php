            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-info btn-fill btn-sm" href="{{ URL::to('/') }}/adm/add/purchase">Tambah
                            Produk</a>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-striped nowrap" id="myTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="text-info"
                                                href="{{ URL::to('/') }}/adm/edit/purchase/{{$row->id}}">edit</a>
                                            &nbsp;&nbsp;
                                            <a rel="tooltip" data-toggle="modal" data-target="#rmThis"
                                                class="text-danger"
                                                href="{{ URL::to('/') }}/ajax/rm/purchase/{{$row->id}}">hapus</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    @endif
