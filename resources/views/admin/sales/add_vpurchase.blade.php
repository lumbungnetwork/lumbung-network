            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Data Produk Vendor</h5>
                    </div>
                    <div class="card-body">
                         <form class="login100-form validate-form" method="post" action="/adm/add/vpurchase">
                            {{ csrf_field() }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="ukuran" required="true" autocomplete="off">
                                    </div>
                                </div>
                            </div>
<!--                            <div class="row">
                                <label class="col-md-2 col-form-label">Harga Vendor</label>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="code" required="true" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
