                            ...
                            <table class="table table-striped nowrap" id="myTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a rel="tooltip" data-toggle="modal" data-target="#popUp1" class="text-info"
                                                href="{{ URL::to('/') }}/ajax/adm/edit-stock/{{$getStockist->id}}/{{$row->purchase_id}}">edit</a>
                                            @if($row->jml_keluar <= 0) &nbsp;&nbsp; <a rel="tooltip" data-toggle="modal"
                                                data-target="#popUp2" class="text-danger"
                                                href="{{ URL::to('/') }}/ajax/adm/rm-stock/{{$getStockist->id}}/{{$row->purchase_id}}">
                                                hapus</a>
                                                @endif
                                        </td>
                                    </tr>
