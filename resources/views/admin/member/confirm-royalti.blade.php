                            ...
                            <table class="table table-striped nowrap" id="myTable">
                                ...
                                <tbody>
                                    @if($getData != null)
                                        ...
                                        <?php 
                                            $no++;
                                            $harga_dasar = ($row->sale_price * 10) / 11;
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a rel="tooltip"  data-toggle="modal" data-target="#popUp" class="text-info" href="{{ URL::to('/') }}/ajax/adm/cek/verivication-royalti/{{$row->id}}">confirm</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
