            ...
            <div class="col-md-12">
                <div class="card card-user">
                    ...
                    <div class="card-body" style="min-height: auto;">
                        <form class="login100-form validate-form" method="post" action="/adm/search-list/member-vendor">
                            {{ csrf_field() }}
                            <div id="addPenjualan">
                                <div class="row">
                                    <div class="col-md-6">
                            ...
                            <table class="table table-striped nowrap" id="myTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="text-info"
                                                href="{{ URL::to('/') }}/adm/vendor/stock/{{$row->id}}">stock</a>
                                            &nbsp;&nbsp;
                                            <a rel="tooltip" data-toggle="modal" data-target="#popUp1"
                                                class="text-danger"
                                                href="{{ URL::to('/') }}/ajax/adm/remove/vendor/{{$row->id}}">hapus</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    @endif
