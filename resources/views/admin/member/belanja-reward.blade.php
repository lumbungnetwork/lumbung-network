                    ...
                    <div class="card-body">
                        ...
                        @endif
                         <div class="table-responsive">
                             <form method="post" name="emailCompose" id="emailCompose" action="/adm/check/belanja-reward">
                                 {{ csrf_field() }}
                             <p class="form-group">
                                    ...
                                    @if($getData != null)
                                        ...
                                        <?php $no++; ?>
                                            <tr>
                                                ...
                                                <td>{{$row->reward}}</td>
                                                <td>
                                                    <a rel="tooltip"  data-toggle="modal" data-target="#popUp" class="text-danger" href="{{ URL::to('/') }}/ajax/adm/cek/reject-belanja-reward/{{$row->id}}">reject</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
