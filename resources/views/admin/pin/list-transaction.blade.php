                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a rel="tooltip" data-toggle="modal" data-target="#popUp" class="text-info"
                                                href="{{ URL::to('/') }}/ajax/adm/cek/transaction/{{$row->id}}/{{$row->user_id}}/{{$row->is_tron}}">confirm</a>
                                            &nbsp;&nbsp;
                                            @endif
                                            <a rel="tooltip" data-toggle="modal" data-target="#popUpReject"
                                                class="text-danger"
                                                href="{{ URL::to('/') }}/ajax/adm/reject/transaction/{{$row->id}}/{{$row->user_id}}/{{$row->is_tron}}">reject</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    @endif
