<form class="login100-form validate-form" method="post" action="/adm/reject-input-vstock">
    {{ csrf_field() }}
    ...
    <div class="modal-body" style="max-height: 400px;overflow-y: auto;">
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" disabled="" value="{{$getDataMaster->username}}">
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" disabled=""
                        value="Rp. {{number_format($royalti, 0, ',', ',')}}">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <div class="form-group">
                    <label>Hash #</label>
                    <textarea class="form-control" id="tron_transfer" readonly=""
                        rows="2">{{$getDataMaster->tron_transfer}}</textarea>
                </div>
            </div>
        </div>
        @endif
