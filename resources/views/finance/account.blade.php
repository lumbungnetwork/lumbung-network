        ...
        <div class="relative bg-gray-100 shadow-lg rounded-3xl">
            ...
            <div class="px-4 py-6">
                ...
                <div class="mt-4 nm-concave-gray-50 rounded-xl p-4 ">
                    ...
                    <p class="text-sm font-light"><strong>Get 50%</strong> from fees generated by every
                        actions your
                        referred users do, FOREVER! <br><br> Minimum 100 USDT needed to activate Referral Bonus. </p>
