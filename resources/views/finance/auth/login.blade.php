    ...
    <div class="relative w-full max-w-md mx-auto">
        ...
        <div class="relative nm-flat-gray-100 rounded-3xl">
            ...
            <div class="px-10 lg:px-20 py-6">
                ...
                <div class="mt-8">
                    <img class="object-contain w-full max-h-32" src="/image/lumbung-finance_2.png"
                        alt="lumbung finance">
                </div>
                ...
                <form class="space-y-5 mt-5" method="POST" action="{{ route('finance.login') }}" autocomplete="off">
                    @csrf
